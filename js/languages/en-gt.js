...
function dueDate ({ P: periodSpan, D: dateStr }) {
    return (
        'To period day period: ' +
        (periodSpan ? periodSpan + ' in ' : '') +
        dateStr
    )
}
...
window.langs['en-gt'] = {
    html: {
        ...
        'disable-lists':
            'ban use all fun unit/work Make people member name single',
        periods: 'Term while',
        'periods-desc':
        ...
        'asgn-display':
            'which is will Finish to make of Ren Service Position Bit',
    ...
    other: {
        ...
        'barcode-student-placeholder':
            'This Yes Who of body Share certificate?',
        ...
        'default-alt-msg':
            'I They of day Cheng An row wish you it is good Luck',
